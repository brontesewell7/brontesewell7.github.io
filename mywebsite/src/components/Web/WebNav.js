    ...
    render() {
        ...
        return (
            <nav id="wecome-navbar">
                    ...
                    <Navbar style={{backgroundColor: window.scrollY > 10 ? "#fafafa" : "transparent", paddingTop: '20px', paddingRight: '10px'}} bg="none" expand="lg" className="navbar-welcome-page fixed-top navbar-expand-sm">
